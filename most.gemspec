...
notes for the list of supplied modules.}
  ...
  s.files = ["Copying.txt", "History.txt", "Manifest.txt", "PostInstall.txt", "README.rdoc", "README.txt", "Rakefile", "bin/most", "lib/most.rb", "lib/most/context.rb", "lib/most/core.rb", "lib/most/di/container.rb", "lib/most/di/proxy.rb", "lib/most/di/service.rb", "lib/most/di/service_factory.rb", "lib/most/environment.rb", "lib/most/executor.rb", "lib/most/helpers/array.rb", "lib/most/helpers/hash.rb", "lib/most/helpers/kernel.rb", "lib/most/helpers/memory_out.rb", "lib/most/helpers/numeric.rb", "lib/most/helpers/object.rb", "lib/most/helpers/symbol.rb", "lib/most/interfaces/meta_programmable.rb", "lib/most/starter.rb", "lib/most/structures/box.rb", "lib/most/structures/submission.rb", "lib/most/structures/test_case.rb", "lib/most/structures/test_runner.rb", "lib/most/structures/types/options.rb", "lib/most/structures/types/path.rb", "lib/most/structures/types/report.rb", "lib/most/submissions/borland_delphi_sample.rb", "lib/most/submissions/brainf_sample.rb", "lib/most/submissions/cpp_memory_out_sample.rb", "lib/most/submissions/cpp_sample.rb", "lib/most/submissions/cpp_timeout_sample.rb", "lib/most/submissions/cs_sample.rb", "lib/most/submissions/custom_delphi_sample.rb", "lib/most/submissions/erlang_sample.rb", "lib/most/submissions/haskell_sample.rb", "lib/most/submissions/java_sample.rb", "lib/most/submissions/lisp_sample.rb", "lib/most/submissions/lua_sample.rb", "lib/most/submissions/ocaml_sample.rb", "lib/most/submissions/pascal_sample.rb", "lib/most/submissions/perl_sample.rb", "lib/most/submissions/php_sample.rb", "lib/most/submissions/python_sample.rb", "lib/most/submissions/ruby_sample.rb", "lib/most/submissions/vb_sample.rb", "lib/most/tasks/general/win/borland_delphi.rb", "lib/most/tasks/general/win/brainf.rb", "lib/most/tasks/general/win/cs.rb", "lib/most/tasks/general/win/erlang.rb", "lib/most/tasks/general/win/gcc.rb", "lib/most/tasks/general/win/haskell.rb", "lib/most/tasks/general/win/java.rb", "lib/most/tasks/general/win/lisp.rb", "lib/most/tasks/general/win/lua.rb", "lib/most/tasks/general/win/ocaml.rb", "lib/most/tasks/general/win/pascal.rb", "lib/most/tasks/general/win/perl.rb", "lib/most/tasks/general/win/php.rb", "lib/most/tasks/general/win/python.rb", "lib/most/tasks/general/win/ruby.rb", "lib/most/tasks/general/win/run.rb", "lib/most/tasks/general/win/vb.rb", "lib/most/tasks/general/win/vc.rb", "lib/most/tasks/general/win/vs.rb", "samples/custom/ones/check.dpr", "samples/custom/ones/ones_is.dpr", "samples/custom/ones/ones_rs.dpr", "samples/custom/ones/problem.xml", "samples/custom/ones/tests/clean.bat", "samples/custom/ones/tests/make.bat", "samples/custom/ones/tests/make_answers.bat", "samples/custom/ones/tests/ones_rs.exe", "samples/custom/ones/tests/shuffle.dpr", "samples/custom/ones/tests/shuffle.exe", "samples/custom/ones/tests/tests.lst", "samples/problem/solutions/brainf/main.b", "samples/problem/solutions/brainf/tests.yml", "samples/problem/solutions/cpp/main.cpp", "samples/problem/solutions/cpp/tests.yml", "samples/problem/solutions/cs/main.cs", "samples/problem/solutions/cs/tests.yml", "samples/problem/solutions/delphi/main.dpr", "samples/problem/solutions/delphi/tests.yml", "samples/problem/solutions/erlang/main.erl", "samples/problem/solutions/erlang/tests.yml", "samples/problem/solutions/haskell/main.hs", "samples/problem/solutions/haskell/tests.yml", "samples/problem/solutions/java/Main.java", "samples/problem/solutions/java/tests.yml", "samples/problem/solutions/lisp/main.lisp", "samples/problem/solutions/lisp/tests.yml", "samples/problem/solutions/lua/main.lua", "samples/problem/solutions/lua/tests.yml", "samples/problem/solutions/ocaml/main.ml", "samples/problem/solutions/ocaml/tests.yml", "samples/problem/solutions/pascal/main.pas", "samples/problem/solutions/pascal/tests.yml", "samples/problem/solutions/perl/main.pl", "samples/problem/solutions/perl/tests.yml", "samples/problem/solutions/php/main.php", "samples/problem/solutions/php/tests.yml", "samples/problem/solutions/python/main.py", "samples/problem/solutions/python/tests.yml", "samples/problem/solutions/ruby/main.rb", "samples/problem/solutions/ruby/tests.yml", "samples/problem/solutions/vb/main.vb", "samples/problem/solutions/vb/tests.yml", "samples/time_memory/solutions/cpp/main.cpp", "samples/time_memory/solutions/cpp/tests.yml", "tasks/samples.rb"]
